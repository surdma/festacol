...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-lg leading-tight font-extrabold tracking-tight",
        className
      )}
      {...props}
    />
