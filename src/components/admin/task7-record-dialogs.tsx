          ...
          {!record ? <RecordLoading label="student record" /> : !user ? <p className="rounded-xl border p-5 text-sm text-muted-foreground">Student record is unavailable.</p> : (
            <div className="flex flex-col gap-6">
              <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
                ...
                <MetricCard label="Placement" value={latestPlacement ? trackLabel(latestPlacement.assigned_track) : "—"} detail={latestPlacement ? `${confidencePercent(latestPlacement.placement_confidence)}% confidence` : "No placement outcome recorded"} />
