...
export function StudentFormDialog({ open, onClose, userId }: { open: boolean; onClose: () => void; userId?: string }) {
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        <FieldGroup>
          <Field>
            ...
            <Input id="student-name" autoComplete="name" value={fullName} onChange={(event) => setFullName(event.target.value)} />
          </Field>
          <Field>
            <FieldLabel htmlFor="student-class">Current class</FieldLabel>
            <NativeSelect id="student-class" value={classId} onChange={(event) => setClassId(event.target.value)}>
          ...
          <Field>
            <FieldLabel htmlFor="student-guardian">Guardian / parent</FieldLabel>
            <Input id="student-guardian" value={guardian} onChange={(event) => setGuardian(event.target.value)} maxLength={80} />
          </Field>
        </FieldGroup>
