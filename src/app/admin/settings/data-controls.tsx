...
const CONTROLS: {
...
}[] = [
  {
    ...
    detail: "Deletes exam definitions and their attempt history in dependency order. The question bank remains.",
  ...
  },
  {
    ...
    detail: "Deletes attempts, normalized responses, integrity events and live/resume state. Exam definitions and the question bank remain.",
