    ...
    <div data-admin-dashboard>
      ...
      <div className="mt-5 grid gap-5 2xl:grid-cols-[1.2fr_.8fr]">
        <section className={`${card} overflow-hidden`}>
          <div className="flex items-center justify-between border-b border-neutral-200 px-5 py-4"><div><p className="text-[10px] font-bold uppercase tracking-[.14em] text-neutral-500">Assessment control</p><h3 className="mt-1 font-display text-lg font-extrabold">Active & recent examinations</h3></div><Link href="/workspace/exams" className={btnSecondary}>All exams</Link></div>
